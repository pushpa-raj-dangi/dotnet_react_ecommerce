import { Box, IconButton,Grid, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, Button } from '@mui/material';
...
export default function BasketItem(){
    ...
    return(
      ...
      <Grid container>
                ...
                <Grid  item xs={6}>
                    <BasketSummary/>
                    <Button fullWidth component={Link} to='/checkout' variant='contained' size='large'> 
                                Checkout
                    </Button>
                </Grid>
      </Grid>
